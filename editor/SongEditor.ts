...
export class SongEditor {
    ...
    private readonly _tabBar: HTMLDivElement = div({ class: "tab-bar-container"}, div({ class: "instrument-bar" }, this._songTabButton, this._instrumentTabButton, this._effectsTabButton));
